...
| ZP61 | a crash between the rename and the exit: the written document stands, no .tmp beside it, and the next --continue reads it | covered: by hand on the box, 2026-09-23, rewritten hand session 1 of box-trip-2026-09-16.md on tool fdab53d; planned: box, by hand, in the worklog of picker-list |
