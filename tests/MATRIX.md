...
| ZP156 | w writes the content merge then sets the resolved attributes in the apply's order: chown, chmod, xattrs, ACL, flags | covered: check_picker.c, a mode change resolved to from's value, an xattr set and one removed, verified after the write |
